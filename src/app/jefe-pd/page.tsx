...
export default function JefePDPage() {
  ...
  `
    ...
    const cargarDatos = async () => {
        try {
            ...
            // Cargar solicitudes del área Sala PD del tenant
    ...
    if (loading) return <div className="p-10 text-center">Cargando Panel de Supervisión PD...</div>
            ...
            <div className={`app-container ${darkMode ? 'dark-mode' : ''} ${currentTheme}`}>
                ...
                <aside className="sidebar">
                    <div className="p-6">
                        ...
                        <p className="text-white/60 text-sm">Supervisión Sala PD</p>
                    </div>
                    <nav className="mt-4">
                ...
                <main className="flex-1 p-8 overflow-y-auto">
                    ...
                    <div className="flex justify-between items-center mb-8 bg-[var(--bg-primary)] p-4 rounded-xl shadow-sm border border-[var(--border-color)]">
                        <div>
                            ...
                            <p className="text-[var(--text-secondary)]">Sala de Diálisis Peritoneal</p>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Ej: Falta de solución de diálisis, catéter defectuoso..."
                            ...
                            <div className="bg-[var(--bg-primary)] p-6 rounded-xl border border-[var(--border-color)] shadow-sm">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-sm font-bold mb-2">Descripción</label>
                                        <textarea
                                            className="w-full p-4 rounded-lg border border-[var(--border-color)] bg-[var(--bg-secondary)] h-32 focus:ring-2 focus:ring-cyan-500 outline-none transition"
                                            placeholder="Ej: Problema con equipos, falta personal..."
                                            value={reporteAdmin}
                                            onChange={e => setReporteAdmin(e.target.value)}
                                        ></textarea>
                                    </div>
                                    <button
                                        className="w-full py-3 bg-cyan-600 text-white rounded-lg font-bold hover:bg-cyan-700 transition"
                    ...
                    <div className="footer-credits text-center py-6 border-t border-slate-100 opacity-80" style={{ marginTop: 'auto' }}>
                        <div className="footer-credits">
                            ...
                            DialyStock © 2025 |
                            <a
                                href={`https://wa.me/573045788873?text=${encodeURIComponent('Hola Manuel, soy el Jefe PD y necesito soporte con DialyStock.')}`}
                                target="_blank"
                ...
                modalDetalle && (
                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[1000] p-4">
                        <div className="bg-[var(--bg-primary)] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in duration-200">
                            <div className="p-6 border-b border-[var(--border-color)] flex justify-between items-center bg-gradient-to-r from-cyan-600 to-blue-600 text-white">
                                <div>
